...
import {RELAY_SERVER_URL as ENV_RELAY_SERVER_URL, DEBUG as ENV_DEBUG} from '@env';
...
// Validate
if (!RELAY_SERVER_URL) {
  throw new Error('❌ RELAY_SERVER_URL is missing. Check your .env or .env.production file.');
}
