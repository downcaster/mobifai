...
export const KEY_DEFINITIONS: KeyDefinition[] = [
  ...
  // Modifiers
  {
    symbol: 'CTRL',
    name: 'Control',
    searchTerms: ['ctrl', 'control', 'CTRL', 'CONTROL'],
    type: 'modifier',
  },
  {
    symbol: 'ALT',
    name: 'Alt/Option',
    searchTerms: ['alt', 'option', 'opt', 'ALT', 'OPTION', 'OPT'],
    type: 'modifier',
  },
  {
    symbol: 'CMD',
    name: 'Command',
    searchTerms: ['cmd', 'command', 'CMD', 'COMMAND'],
    type: 'modifier',
  },
  {
    symbol: 'SHIFT',
    name: 'Shift',
    searchTerms: ['shift', 'SHIFT'],
    type: 'modifier',
  },
  {
    symbol: 'META',
  ...
  // Navigation Keys
  {
    symbol: '↵',
    name: 'Enter',
    searchTerms: ['enter', 'return', 'ENTER', 'RETURN'],
    type: 'navigation',
    escapeSequence: '\r',
  },
  {
  ...
  },
  {
    symbol: 'SHIFT+TAB',
    name: 'Backtab',
    searchTerms: ['shift+tab', 'shift tab', 'backtab', 'SHIFT+TAB', 'SHIFT TAB', 'BACKTAB'],
    type: 'navigation',
    escapeSequence: '\x1b[Z',
  },
  {
    symbol: '⎋',
    name: 'Escape',
    searchTerms: ['escape', 'esc', 'ESCAPE', 'ESC'],
    type: 'navigation',
    escapeSequence: '\x1b',
  },
  {
  ...
  },
  {
    symbol: '⌫',
    name: 'Backspace',
    searchTerms: ['backspace', 'BACKSPACE'],
    type: 'navigation',
    escapeSequence: '\x7f',
  },
  {
    symbol: '⌦',
    name: 'Delete',
    searchTerms: ['delete', 'del', 'DELETE', 'DEL'],
    type: 'navigation',
    escapeSequence: '\x1b[3~',
  },
  {
    symbol: '↑',
    name: 'Up',
    searchTerms: ['up', 'arrow up', 'UP'],
    type: 'navigation',
    escapeSequence: '\x1b[A',
  },
  {
    symbol: '↓',
    name: 'Down',
    searchTerms: ['down', 'arrow down', 'DOWN'],
    type: 'navigation',
    escapeSequence: '\x1b[B',
  },
  {
    symbol: '→',
    name: 'Right',
    searchTerms: ['right', 'arrow right', 'RIGHT'],
    type: 'navigation',
    escapeSequence: '\x1b[C',
  },
  {
    symbol: '←',
    name: 'Left',
    searchTerms: ['left', 'arrow left', 'LEFT'],
    type: 'navigation',
    escapeSequence: '\x1b[D',
  },
  {
    symbol: '↖',
    name: 'Home',
    searchTerms: ['home', 'HOME'],
    type: 'navigation',
  ...
  },
  {
    symbol: '⇞',
    name: 'Page Up',
    searchTerms: ['pageup', 'page up', 'pgup', 'PAGEUP'],
    type: 'navigation',
    escapeSequence: '\x1b[5~',
  },
  {
    symbol: '⇟',
    name: 'Page Down',
    searchTerms: ['pagedown', 'page down', 'pgdn', 'PAGEDOWN'],
    type: 'navigation',
    escapeSequence: '\x1b[6~',
  },
  ...
  // Control Sequences (Ctrl+Key combinations)
  {
    ...
    searchTerms: ['ctrl+a', 'control+a', 'CTRL+A'],
    type: 'control',
    escapeSequence: '\x01',
  },
  {
    symbol: 'CTRL+C',
    name: 'Interrupt',
    searchTerms: ['ctrl+c', 'control+c', 'CTRL+C'],
    type: 'control',
    escapeSequence: '\x03',
  },
  {
    symbol: 'CTRL+D',
    name: 'End of input',
    searchTerms: ['ctrl+d', 'control+d', 'CTRL+D'],
    type: 'control',
    escapeSequence: '\x04',
  },
  {
    symbol: 'CTRL+E',
    name: 'Move to end',
    searchTerms: ['ctrl+e', 'control+e', 'CTRL+E'],
    type: 'control',
    escapeSequence: '\x05',
  },
  {
    symbol: 'CTRL+K',
    name: 'Kill line after',
    searchTerms: ['ctrl+k', 'control+k', 'CTRL+K'],
    type: 'control',
    escapeSequence: '\x0b',
  },
  {
    symbol: 'CTRL+L',
    name: 'Clear screen',
    searchTerms: ['ctrl+l', 'control+l', 'CTRL+L'],
    type: 'control',
    escapeSequence: '\x0c',
  },
  {
    symbol: 'CTRL+R',
    name: 'Search history',
    searchTerms: ['ctrl+r', 'control+r', 'CTRL+R'],
    type: 'control',
    escapeSequence: '\x12',
  },
  {
    symbol: 'CTRL+U',
    name: 'Kill line before',
    searchTerms: ['ctrl+u', 'control+u', 'CTRL+U'],
    type: 'control',
    escapeSequence: '\x15',
  },
  {
    symbol: 'CTRL+W',
    name: 'Delete word',
    searchTerms: ['ctrl+w', 'control+w', 'CTRL+W'],
    type: 'control',
    escapeSequence: '\x17',
  },
  {
    ...
    searchTerms: ['ctrl+z', 'control+z', 'CTRL+Z'],
    type: 'control',
    escapeSequence: '\x1a',
  },
  {
  ...
  // Special Characters
  {
    symbol: '~',
    name: 'Tilde',
    searchTerms: ['~', 'tilde', 'TILDE'],
    type: 'special',
  },
  {
    symbol: '`',
    name: 'Backtick',
    searchTerms: ['`', 'backtick', 'grave', 'BACKTICK'],
    type: 'special',
  },
  {
    symbol: '!',
    name: 'Exclamation',
    searchTerms: ['!', 'exclamation', 'bang', 'EXCLAMATION'],
    type: 'special',
  },
  {symbol: '@', name: 'At', searchTerms: ['@', 'at', 'AT'], type: 'special'},
  {
    symbol: '#',
    name: 'Hash',
    searchTerms: ['#', 'hash', 'pound', 'HASH'],
    type: 'special',
  },
  {
    symbol: '$',
    name: 'Dollar',
    searchTerms: ['$', 'dollar', 'DOLLAR'],
    type: 'special',
  },
  {
    symbol: '%',
    name: 'Percent',
    searchTerms: ['%', 'percent', 'PERCENT'],
    type: 'special',
  },
  {
    symbol: '^',
    name: 'Caret',
    searchTerms: ['^', 'caret', 'CARET'],
    type: 'special',
  },
  {
    symbol: '&',
    name: 'Ampersand',
    searchTerms: ['&', 'ampersand', 'and', 'AMPERSAND'],
    type: 'special',
  },
  {
    symbol: '*',
    name: 'Asterisk',
    searchTerms: ['*', 'asterisk', 'star', 'ASTERISK'],
    type: 'special',
  },
  {
    symbol: '(',
    name: 'Left Parenthesis',
    searchTerms: ['(', 'lparen', 'left paren', 'LPAREN'],
    type: 'special',
  },
  {
    symbol: ')',
    name: 'Right Parenthesis',
    searchTerms: [')', 'rparen', 'right paren', 'RPAREN'],
    type: 'special',
  },
  {
    symbol: '-',
    name: 'Minus',
    searchTerms: ['-', 'minus', 'dash', 'hyphen', 'MINUS'],
    type: 'special',
  },
  {
    symbol: '_',
    name: 'Underscore',
    searchTerms: ['_', 'underscore', 'UNDERSCORE'],
    type: 'special',
  },
  {
    symbol: '=',
    name: 'Equal',
    searchTerms: ['=', 'equal', 'equals', 'EQUAL'],
    type: 'special',
  },
  {
    symbol: '+',
    name: 'Plus',
    searchTerms: ['+', 'plus', 'PLUS'],
    type: 'special',
  },
  {
    symbol: '[',
    name: 'Left Bracket',
    searchTerms: ['[', 'lbracket', 'left bracket', 'LBRACKET'],
    type: 'special',
  },
  {
    symbol: ']',
    name: 'Right Bracket',
    searchTerms: [']', 'rbracket', 'right bracket', 'RBRACKET'],
    type: 'special',
  },
  {
    symbol: '{',
    name: 'Left Brace',
    searchTerms: ['{', 'lbrace', 'left brace', 'LBRACE'],
    type: 'special',
  },
  {
    symbol: '}',
    name: 'Right Brace',
    searchTerms: ['}', 'rbrace', 'right brace', 'RBRACE'],
    type: 'special',
  },
  {
    symbol: '\\',
    name: 'Backslash',
    searchTerms: ['\\', 'backslash', 'BACKSLASH'],
    type: 'special',
  },
  {
    symbol: '|',
    name: 'Pipe',
    searchTerms: ['|', 'pipe', 'bar', 'PIPE'],
    type: 'special',
  },
  {
    symbol: ';',
    name: 'Semicolon',
    searchTerms: [';', 'semicolon', 'SEMICOLON'],
    type: 'special',
  },
  {
    symbol: ':',
    name: 'Colon',
    searchTerms: [':', 'colon', 'COLON'],
    type: 'special',
  },
  {
    symbol: "'",
    name: 'Single Quote',
    searchTerms: ["'", 'quote', 'single quote', 'apostrophe', 'QUOTE'],
    type: 'special',
  },
  {
    symbol: '"',
    name: 'Double Quote',
    searchTerms: ['"', 'double quote', 'quotes', 'DOUBLEQUOTE'],
    type: 'special',
  },
  {
    symbol: ',',
    name: 'Comma',
    searchTerms: [',', 'comma', 'COMMA'],
    type: 'special',
  },
  {
    symbol: '.',
    name: 'Period',
    searchTerms: ['.', 'period', 'dot', 'PERIOD'],
    type: 'special',
  },
  {
    symbol: '<',
    name: 'Less Than',
    searchTerms: ['<', 'less', 'lt', 'LESS'],
    type: 'special',
  },
  {
    symbol: '>',
    name: 'Greater Than',
    searchTerms: ['>', 'greater', 'gt', 'GREATER'],
    type: 'special',
  },
  {
    symbol: '/',
    name: 'Slash',
    searchTerms: ['/', 'slash', 'forward slash', 'SLASH'],
    type: 'special',
  },
  {
    symbol: '?',
    name: 'Question',
    searchTerms: ['?', 'question', 'QUESTION'],
    type: 'special',
  },
];
...
export function searchKeys(query: string): KeyDefinition[] {
  ...
  return KEY_DEFINITIONS.filter(key => {
    ...
    return key.searchTerms.some(term => term.toLowerCase().includes(lowerQuery));
  });
}
...
export function combineKeys(keys: KeyDefinition[]): string {
  ...
  if (keys.length === 1) {
    return keys[0].escapeSequence || keys[0].symbol;
  }
